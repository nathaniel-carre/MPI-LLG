...
Dans le préambule, on a chargé le paquet et défini les couleurs de la coloration syntaxique avec :
\begin{verbatim}
\usepackage{listings}
\usepackage{xcolor}
...
En entête, on a chargé l'environnement de pseudo-code avec :

\begin{verbatim}
\usepackage[vlined, french, onelanguage]{algorithm2e}
\end{verbatim}

L'option \verb"french" permet d'avoir les mots-clés en français.
...
On peut choisir de numéroter les lignes.
...
Voire de donner des noms à des fonctions/programmes :

\SetKwProg{Fn}{Fonction}{}{}
\SetKwFunction{tipe}{TIPE}
\LinesNumberedHidden
\begin{algorithm}[H]
	\Fn{\tipe{}}{
		\If{\text{\upshape le TIPE n'est pas terminé}}{
			\tipe{}
		}
	}
	\caption{Comment faire son TIPE}
\end{algorithm}
